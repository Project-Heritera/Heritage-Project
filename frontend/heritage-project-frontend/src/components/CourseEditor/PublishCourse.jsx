    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[230px]">
                <DialogHeader>
                    <DialogTitle>{published ? "Are you sure you want to make your course private?" : "Are you sure you want to publish?"}</DialogTitle>
                    <DialogDescription>
                        {published ? "Privating your course will remove it and the rooms from the course page. However all obtained badges will remain in the users profile" : "Publishing your course will make all published rooms available to all users on the course page."}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex justify-between w-full">
                    ...
                    <Button className="hover:shadow-lg transition-shadow cursor-pointer" onClick={published ? handlePrivate : handlePublish}>
                        Yes
                    </Button>
                </div>
            </DialogContent>
