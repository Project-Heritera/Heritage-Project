...
function CourseDashboard() {
    ...
    return (
        // FIXED: changed bg-gray-50 to bg-muted/40
        <div className="flex flex-col w-full min-h-screen bg-muted/40">
            {/* Header Area */}
            {/* FIXED: changed bg-white to bg-background */}
            <div className="w-full bg-background border-b px-6 py-4 mb-8">
                <div className="max-w-[60%] mx-auto">
                    {/* Added text-foreground just to be safe */}
            ...
            <div className="flex w-full max-w-[60%] mx-auto px-6 gap-10 items-start">
                ...
                <div className="flex-1">
                    <Card className="w-full shadow-sm">
                        {/* FIXED: changed bg-gray-50/50 to bg-muted/50 */}
